...
tbCreate = "create table nj_state_teachers_salaries (last_name VARCHAR(45) NOT NULL, first_name VARCHAR(45) NOT NULL,	county VARCHAR(45) NOT NULL,	district VARCHAR(100) NOT NULL,	school VARCHAR(100) NOT NULL,	primary_job TEXT NOT NULL,	fte INT NOT NULL,	salary INT NOT NULL,	certificate	VARCHAR(45) NOT NULL, subcategory VARCHAR(32) NOT NULL,	teaching_route  VARCHAR(32) NOT NULL,	highly_qualified VARCHAR(100) NOT NULL,	experience_district INT NOT NULL,	experience_nj INT NOT NULL,	experience_total INT NOT NULL);"
